...
function Sidebar({
  ...
  return (
    <div
      className="group peer hidden text-sidebar-foreground md:block shadow-xl z-1"
      data-state={state}
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-sm px-3 py-3 text-left text-sm font-semibold whitespace-nowrap ring-sidebar-ring outline-hidden transition-[width,height,padding,background,color,gap] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-12! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-popup-open:bg-sidebar-accent hover:bg-sidebar-accent data-popup-open:text-sidebar-accent-foreground hover:text-sidebar-accent-foreground data-active:bg-sidebar-accent [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "h-9 text-sm",
        sm: "h-8 text-xs",
        lg: "h-12 text-base group-data-[collapsible=icon]:p-3! group-data-[collapsible=icon]:gap-3.5! [&>:first-child:has(svg)>svg:not([class*='size-'])]:size-5", // fix icon size for lg variant
      },
    },
    defaultVariants: {
      variant: "default",
