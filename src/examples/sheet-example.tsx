    ...
    <Example title="With Form">
      <Sheet>
        ...
        <SheetContent>
          ...
          <div className="px-4 style-nova:px-4 style-lyra:px-4 style-maia:px-6 style-mira:px-6 style-luma:px-6">
            <FieldGroup>
              <Field>
        ...
        {SHEET_SIDES.map((side) => (
          <Sheet key={side}>
            ...
            >
              ...
              <div className="no-scrollbar overflow-y-auto px-4 style-nova:px-4 style-lyra:px-4 style-maia:px-6 style-mira:px-6 style-luma:px-6">
