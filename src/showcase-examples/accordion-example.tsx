...
function AccordionWithBorders() {
  ...
  return (
    <Example title="With Borders">
      <Accordion className="mx-auto max-w-lg gap-2 style-nova:gap-2 style-lyra:gap-2">
        {items.map((item) => (
          <AccordionItem
            key={item.value}
            value={item.value}
            className="rounded-lg border style-nova:rounded-lg style-nova:border style-lyra:border"
          >
            <AccordionTrigger className="font-medium px-4 text-sm style-nova:px-2.5 style-nova:text-sm style-lyra:px-2 style-lyra:text-xs style-maia:text-sm style-mira:text-xs style-luma:text-sm">
              {item.trigger}
            </AccordionTrigger>
            <AccordionContent className="text-muted-foreground px-4 style-nova:px-2.5 style-nova:text-sm style-lyra:px-2 style-lyra:text-xs style-maia:px-0 style-mira:px-0 style-luma:px-0">
              {item.content}
            </AccordionContent>
          </AccordionItem>
        ))}
      ...
      <Accordion className="mx-auto max-w-lg overflow-hidden border rounded-lg style-nova:rounded-lg style-lyra:rounded-none style-maia:rounded-lg style-mira:rounded-lg style-luma:rounded-xl">
        {items.map((item) => (
          ...
          >
            ...
            <AccordionContent className="px-4 style-nova:px-2.5 style-lyra:px-2">
              {item.content}
            </AccordionContent>
          </AccordionItem>
        ))}
