...
function DragHandle({ id }: { id: number }) {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon-sm"
      className="text-muted-foreground hover:cursor-grab dark:text-muted-foreground"
    >
      <DotsSixVerticalIcon />
  ...
  return (
    <Drawer direction={isMobile ? "bottom" : "right"}>
      <DrawerTrigger asChild>
        <Button variant="link-neutral" className="w-fit px-0 text-left text-foreground">
          {item.header}
        </Button>
      </DrawerTrigger>
      <DrawerContent>
